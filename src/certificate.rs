...
use der::asn1::{
    BitStringRef, GeneralizedTime, IntRef, ObjectIdentifier, OctetStringRef, SequenceOf, SetOf,
    UtcTime,
};
...
pub struct ParsedCertificate<'a, const MAX_EXTENSIONS: usize> {
    pub tbs_certificate: TbsCertificate<'a, MAX_EXTENSIONS>,
...
#[derive(Debug, Sequence, ValueOrd)]
pub struct TbsCertificate<'a, const MAX_EXTENSIONS: usize> {
    ...
    pub extensions: Option<SequenceOf<Extension<'a>, MAX_EXTENSIONS>>,
}